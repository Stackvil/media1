...
export default function NewsCard({ title, summary, category, date, imageUrl, slug, featured = false }: NewsCardProps) {
    return (
        <article className={cn(
            "flex flex-col group bg-white rounded-lg overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow",
            ...
            <div className="p-6 flex flex-col justify-between">
                ...
                <div className="mt-6">
                    <Link href={`/news/${slug}`} className="inline-flex items-center text-secondary font-bold text-sm hover:text-secondary-dark group/link">
                        Read Full Story
